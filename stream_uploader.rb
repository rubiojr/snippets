#
# Adapted by Sergio Rubio <srubio@abiquo.com> for Abiquo
#
...
file = '/home/rubiojr/.vagrant/boxes/fos/frameos-5.5b2.vmdk'
fo = File.new(file)
...
json = '''{
"idEnterprise":1,
"ovfUrl":"http://upload/frameos/frameos.ovf",
"diskFileFormat":"VMDK_STREAM_OPTIMIZED",
"name":"XFrameOS",
"description":"XXFrameOS 5.5b2",
"categoryName":"Operatin Systems",
"iconPath":"http://www.pixeljoint.com/files/icons/mipreview1.gif",
"cpu":1,
"hd": 44382003200,
"ram":268435456
}'''
StreamingUploader.post('http://thunder05:8080/am/er/1/ovf/upload', { :ovfpackageinstance => json, :diskFile => fo }) do |size|
  count += size
  print "#{line_reset}Uploading template: #{(100*count)/fsize}% " 
end
